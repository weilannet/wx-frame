<template>
  <div>
    ...
    <group title="两次输入需要保持一致">
      <x-input title="设置密码" type="password" placeholder="" :value.sync="txtpwd"  :equal-with="txtpwd2"  :min="6" :max="12" @change="pwdChange" required v-ref:inputpwd></x-input>
